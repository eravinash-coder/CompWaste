package com.example.compwaste.SendNotification;
...
import com.example.compwaste.AdminPanel.AdminPreparedOrderView;
import com.example.compwaste.AdminWastePanel_BottomNavigation;
import com.example.compwaste.CustomerPanel.PayableOrders;
import com.example.compwaste.CustomerFoodPanel_BottomNavigation;
import com.example.compwaste.Delivery_FoodPanelBottomNavigation;
import com.example.compwaste.MainActivity;
...
public class ShowNotification {
    ...
    public static void ShowNotif(Context context, String title, String message, String page) {
        ...
        if (page.trim().equalsIgnoreCase("Order")) {
            acIntent = new Intent(context, AdminWastePanel_BottomNavigation.class).putExtra("PAGE", "Orderpage");
        ...
        if (page.trim().equalsIgnoreCase("Confirm")) {
            acIntent = new Intent(context, AdminWastePanel_BottomNavigation.class).putExtra("PAGE", "Confirmpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("AcceptOrder")) {
            acIntent = new Intent(context, AdminWastePanel_BottomNavigation.class).putExtra("PAGE", "AcceptOrderpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
        ...
        if (page.trim().equalsIgnoreCase("Delivered")) {
            acIntent = new Intent(context, AdminWastePanel_BottomNavigation.class).putExtra("PAGE", "Deliveredpage");
            pendingIntent = PendingIntent.getActivity(context, 0, acIntent, PendingIntent.FLAG_ONE_SHOT);
        }
