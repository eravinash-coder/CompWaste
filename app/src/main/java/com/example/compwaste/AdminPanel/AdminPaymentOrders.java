...
public class AdminPaymentOrders {
    ...
    public AdminPaymentOrders(String chefId, String dishId, String dishName, String dishPrice, String dishQuantity, String randomUID, String totalPrice, String userId) {
        ChefId = chefId;
        DishId = dishId;
        DishName = dishName;
        DishPrice = dishPrice;
