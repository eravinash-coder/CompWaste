...
public class AdminPendingOrders {
    ...
    public AdminPendingOrders(String chefId, String dishId, String dishName, String dishQuantity, String price, String randomUID, String totalPrice, String userId) {
        ChefId = chefId;
        DishId = dishId;
        DishName = dishName;
