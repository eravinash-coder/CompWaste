...
import com.example.compwaste.Customer;
...
public class OrderWaste extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("WasteSupplyDetails").child(State).child(City).child(Sub).child(ChefID).child(RandomId);
                databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        UpdateWasteModel updateWasteModel = dataSnapshot.getValue(UpdateWasteModel.class);
                        Foodname.setText(updateWasteModel.getDishes());
                        String qua = "<b>" + "Minimum Quantity: " + "</b>" + updateWasteModel.getQuantity();
                        FoodQuantity.setText(Html.fromHtml(qua));
                        String ss = "<b>" + "Description: " + "</b>" + updateWasteModel.getDescription();
                        FoodDescription.setText(Html.fromHtml(ss));
                        String pri = "<b>" + "Reward per kg : ₹ " + "</b>" + updateWasteModel.getPrice();
                        FoodPrice.setText(Html.fromHtml(pri));
                        Glide.with(OrderWaste.this).load(updateWasteModel.getImageURL()).into(imageView);

                        chefdata = FirebaseDatabase.getInstance().getReference("Admin").child(ChefID);
                        chefdata.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                Chef chef = dataSnapshot.getValue(Chef.class);

                                String name = "<b>" + "Admin Name: " + "</b>" + chef.getFname() + " " + chef.getLname();
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.exists()) {
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        data = FirebaseDatabase.getInstance().getReference("WasteSupplyDetails").child(State).child(City).child(Sub).child(ChefID).child(RandomId);
                                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                UpdateWasteModel update = dataSnapshot.getValue(UpdateWasteModel.class);
                                                ...
                                                if (num != 0) {
                                                    ...
                                                    reference.setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        ...
                                                        public void onSuccess(Void aVoid) {
                                                            ...
                                                            Toast.makeText(OrderWaste.this, "Added to cart", Toast.LENGTH_SHORT).show();
                                                        }
                                                    });
                                    ...
                                    {
                                        AlertDialog.Builder builder = new AlertDialog.Builder(OrderWaste.this);
                                        ...
                                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                dialog.dismiss();
                                                Intent intent = new Intent(OrderWaste.this, CustomerFoodPanel_BottomNavigation.class);
