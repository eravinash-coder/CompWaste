...
public class CustomerHomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void customermenu() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        databaseReference = FirebaseDatabase.getInstance().getReference("WasteSupplyDetails").child(State).child(City).child(Sub);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                        UpdateWasteModel updateWasteModel = snapshot1.getValue(UpdateWasteModel.class);
                        updateWasteModelList.add(updateWasteModel);
                    }
                }
                adapter = new CustomerHomeAdapter(getContext(), updateWasteModelList);
    ...
    private void search(final String searchtext) {
        ...
        ArrayList<UpdateWasteModel> mylist = new ArrayList<>();
        for (UpdateWasteModel object : updateWasteModelList) {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        searchView.setQueryHint("Search Waste");
