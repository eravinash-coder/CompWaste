                                                                                                ...
                                                                                                getRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                    ...
                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                        ...
                                                                                                        for (DataSnapshot dataSnapshot2 : dataSnapshot.getChildren()) {
                                                                                                            ...
                                                                                                            FirebaseDatabase.getInstance().getReference("AdminPendingOrders").child(ChefId).child(RandomUId).child("Dishes").child(d).setValue(hashMap2);
                                                                                                        }
                                                                                                        ...
                                                                                                        dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                            ...
                                                                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                ...
                                                                                                                FirebaseDatabase.getInstance().getReference("AdminPendingOrders").child(ChefId).child(RandomUId).child("OtherInformation").setValue(hashMap3).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                                    @Override
                                                                                                                            ...
                                                                                                                            public void onSuccess(Void aVoid) {
                                                                                                                                ...
                                                                                                                                FirebaseDatabase.getInstance().getReference().child("Tokens").child(ChefId).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                                                                    ...
                                                                                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                                                                                        ...
                                                                                                                                        ReusableCodeForAll.ShowAlert(getContext(), "", "Your Request has been shifted to Pending state, please wait until the Admin accept your order.");
                                                                                                                                    }
...
//                                                                }
                                                ...
                                                ReusableCodeForAll.ShowAlert(getContext(), "Error", "It seems you have already placed the Request, So you cannot place another Request until the delivery of first order");
                                            }
